...
update_ics_file(url_2025_stage1_amer, stage1_event, ics_file_path)
update_ics_file(url_2025_stage1_pac, stage1_event, ics_file_path)
update_ics_file(url_2025_stage1_emea, stage1_event, ics_file_path)
